...
class TestAlgoritmos(object):
    ...
    def test_busqueda_lineal_encontrar_elemento_inexistente(self):
        ...
        assert str(e.value) == "No se encontró el elemento."
    ...
    def test_bubble_sort_lista_real_desordenada_312_retorna_123(self):
        # Given
        lista = [3, 1, 2]
    ...
    def test_binary_search_encontrar_elemento_inexistente_en_mitad_izquierda(self):
        # Given
        lista = [1, 3, 5]
        objetivo = 2
    ...
    def test_busqueda_lineal_encontrar_elemento_existente_en_cadena(self):
        # Given
        lista = "hola mundo"
        objetivo = "o"
    ...
    def test_busqueda_lineal_encontrar_elemento_inexistente_en_cadena(self):
        # Given
        lista = "hola mundo"
        objetivo = "x"
