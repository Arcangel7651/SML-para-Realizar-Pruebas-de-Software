...
- Generado: 2026-06-16T19:13:00.728Z
...
ADVERTENCIA para el módulo 'procesador_descuentos': en una generación previa, estos tests fallaron al ejecutarse porque su aserción no se cumplió:
  - test_aplicar_descuento_negativo_porcentaje: assert resultado == precio → assert 105.0 == 100
  - test_precio_unitario_negativo_cantidad: Failed: DID NOT RAISE <class 'ZeroDivisionError'>
  - test_aplicar_descuento_escalonado_cero_cantidad: assert resultado == 95 → Failed: DID NOT RAISE <class 'ZeroDivisionError'> | assert 100.0 == 95
