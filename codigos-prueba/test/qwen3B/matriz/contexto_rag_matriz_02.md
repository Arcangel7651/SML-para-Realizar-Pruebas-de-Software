...
- Generado: 2026-06-15T05:22:50.600Z
...
ADVERTENCIA para el módulo 'matriz': en una generación previa, estos tests fallaron al ejecutarse porque su aserción no se cumplió:
  - test_sumar_matrices_diferentes_dimensiones_lanza_error: Failed: DID NOT RAISE <class 'ValueError'> | Failed: DID NOT RAISE <class 'ValueError'>
...
```text
[meta score=88.11 kept=11] Ejemplo verificado de tests pytest para el módulo 'calculadora' (funciones: sumar, restar, multiplicar, dividir, potencia, es_par). 11 test(s) verificados que pasan, 88.0% de cobertura de línea. Código de prueba:
import pytest
from calculadora import Calculadora
